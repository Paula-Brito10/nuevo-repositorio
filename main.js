document.addEventListener("DOMContentLoaded", function () {
    ...
    const mostrarOfertasButton = document.getElementById("mostrar-ofertas");  // Agregamos el botón de "ofertas"
    const mostrarDescuentosButton = document.getElementById("mostrar-descuentos");// Agregamos el botón de "descuentos"
    const mostrarCombosButton = document.getElementById("mostrar-combos"); // Agregamos el botón de "Combos"
                ...
                const productoHTML = `
                    <article class="single-product">
                        <div class="product-image">
                            ...
                            <div class="overlay">
                                <button class="Añadir_al_Carrito">Añadir al Carrito</button>
                            </div>
                        </div>
                        <div class="info">
